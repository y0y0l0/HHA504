...
def http_trigger1(req: func.HttpRequest) -> func.HttpResponse:
    ...
    category ='unknown'# "Normal" if float(spo2) >= 92 else "Abnormal Chronic Condition Warning!"
    status= 'None'#"Hello, {name}. Your oxigenation is {spo2} with pulse rate of {pulse}.".format(name=name, spo2=spo2, pulse=pulse),
    try:
